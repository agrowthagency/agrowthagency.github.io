...
- A client-owned Google Ads account linked to an agency manager account.
- A client account created by the agency’s manager, making that manager the initial owner.
- An account using consolidated billing or a paying manager.
...
This creates a straightforward standard: the agency layer should clarify the advertiser, not replace it.

Maintain evidence of:

- The client’s legal entity and public brand.
- The client-agency authorization.
- Who supplies the advertised product or service.
- Who owns the website and customer relationship.
- Who pays Google and why.
- Which organization should appear in the advertiser disclosure.
...
- Direct client administrative access.
- Ownership and transfer conditions.
- Conversion and audience portability.
- Billing transparency and reconciliation.
- Data retention and deletion.
- A timed offboarding procedure.
...
They also concentrate risk. The client may pre-fund the agency. Several client accounts may share one billing setup. A dispute or failed payment at the paying-manager level can interrupt campaigns. Refunds and credits may be controlled by a different entity from the advertiser.

A commercial agreement should separate:

- Google media cost.
- Agency fee.
- Taxes and currency conversion.
- Deposits or credit terms.
- Promotional credits.
...
Who contracts with the client? Is that the same entity that owns the manager or provides billing? Can the provider substantiate any claimed Google relationship without implying endorsement that does not exist?
...
Can the client export reports, retain conversion history, control domains and Merchant Center, and maintain direct admin access? What exactly transfers at termination?

### Policy responsibility

Who approves regulated offers, claims, landing pages, tracking, and verification? What happens after a warning or suspension? A provider should never market account replacement as the default answer to enforcement.
...
That standard also protects the agency. Clear boundaries reduce disputes over unauthorized changes, unpaid balances, inaccessible accounts, and client activity outside the agency’s control.
