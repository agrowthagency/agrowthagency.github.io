...
topic: "Agency account suspension response"
title: "Agency Account Suspension Response: One Incident, Several Responsibilities"
description: "A cross-platform incident framework for agencies handling client account suspensions across triage, evidence, security, billing, appeals, and communication."
overview: "An agency suspension incident can affect a client account, agency manager or Business Center, user, payment function, or shared asset. Response begins by identifying scope and dependency."
...
Do not call every event an “agency account ban.”

## Open one incident with separated workstreams

| Workstream | Owner | Evidence |
| --- | --- | --- |
| Policy/campaign | Media and compliance | Ads, labels, Account Health/history |
| Destination/product | Client and web owner | Releases, offer, qualifications, fulfillment |
| Access/security | Security and platform ops | Users, partners, sessions, change history |
| Billing | Finance | Transactions, payer, balance, issuer, invoices |
| Identity | Client legal/operations | Entity, brand, verification, licenses |
| Communication | Incident/client lead | Confirmed status, cases, decisions |
...
## Contain without bypass

Pause unauthorized or confirmed risky systems, secure accounts, remove unknown access, stop defective feeds or destinations, and reconcile payment. Do not create replacement accounts, identities, domains, or manager structures to continue unresolved activity.

Platform guidance across Meta and TikTok identifies evasion or replacement behavior as a concern, and Google’s circumventing-systems policy reaches attempts to bypass enforcement.

## Build the appeal from client and agency facts
...
Require verified access, billing, identity, destination, catalog, and reviewed campaign inventory. Restore known objects in stages with monitoring. Reinstatement is not evidence that every control is healthy.

## Run a portfolio lesson review

Search for the same template, user, partner, feed, destination component, certificate process, payer, or provider across accounts. Assign controls with owners and validation dates.

The incident belongs to the client whose account was affected and to the agency system that may have produced or amplified it.

## Use incident gates

Define explicit gates for containment, fact completion, appeal approval, controlled restart, and closure. Each gate needs an owner and evidence requirement. This prevents commercial pressure from turning an incomplete diagnosis into repeated submissions or a premature relaunch.
...
- [Google Ads suspension overview](https://support.google.com/adspolicy/answer/9841640?hl=en)
- [Meta ad review and account restrictions](https://www.facebook.com/business/ads/review-policy-guidelines)
- [TikTok suspended ad accounts](https://ads.tiktok.com/help/article/account-suspensions?lang=en)
