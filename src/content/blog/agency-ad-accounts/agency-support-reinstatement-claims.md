...
topic: "Agency support and reinstatement claims"
title: "Agency Support and Reinstatement Claims: Access Is Not Decision Authority"
description: "A due-diligence framework for agency support, escalation, appeal, reinstatement, replacement, response-time, and platform-partner claims."
overview: "An agency may have experience, account managers, or support channels that improve case handling. None transfers the platform's authority to approve ads, restore accounts, or preserve spending capacity."
...
| --- | --- |
| Dedicated support | Agency employee, platform rep, or reseller? |
| Priority escalation | Which channel and eligibility? |
| Fast appeal | Agency preparation time or platform response? |
| Guaranteed reinstatement | Not credible; who supposedly controls the decision? |
| Free replacement | Which asset/data/balance survives and under what exclusions? |
| Partner account | Which program, entity, current evidence, and scope? |

Capture exact wording in the contract and a claim-verification worksheet.

## Separate four service layers

1. **Detection:** monitoring notices, policy health, security, and billing.
2. **Incident response:** classification, evidence, containment, client communication.
3. **Platform contact:** using an available ticket, representative, or review route.
4. **Platform decision:** approval, restriction, appeal outcome, refund, limit, or access.
...
The agency can promise to acknowledge an incident, preserve evidence, start containment, request client information, submit an approved case, and update at defined intervals. It should not promise the platform will answer or reinstate within the same window.
...
For every commercial statement—“priority,” “dedicated,” “direct,” “fast,” or “replacement”—record the exact service, evidence, exclusions, owner, and review date. Replace ambiguous language with observable commitments. If the provider cannot substantiate the route without revealing protected details, it can still show anonymized process records and historical service measures.
...
## Prepare for loss of the support route

Document what happens if a representative changes, a provider relationship ends, the agency business container is restricted, or a support product is withdrawn. Retain official self-service paths, client administrators, case identifiers, evidence, and contractual contacts. A credible operation can degrade gracefully rather than becoming unreachable.
