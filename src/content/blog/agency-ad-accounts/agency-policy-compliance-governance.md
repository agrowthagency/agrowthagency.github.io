...
topic: "Agency policy compliance governance"
title: "Agency Policy Compliance: Governance Must Sit Upstream of the Ad"
description: "An operating framework for agency compliance across client eligibility, claims, destinations, approvals, Account Health, repeated violations, and evidence."
overview: "Agency compliance is not a final creative checklist. It is the governance system connecting client facts, product eligibility, claims, media configuration, destinations, and portfolio learning."
...
Do not onboard a client because another agency or account previously delivered its ads. Approval history is not transferable eligibility evidence.

## Assign decision ownership

| Decision | Accountable owner |
| --- | --- |
| Product legality and real operation | Client business/legal owner |
| Industry and platform eligibility | Compliance owner |
| Claim evidence | Client/product owner |
| Creative execution | Agency creative lead |
| Targeting and placement | Media lead |
| Destination and conversion flow | Web/product owner |
| Account identity and access | Platform operations owner |
| Final publication | Named approver |

The agency should stop launch when a required owner cannot provide the fact.

## Build reusable controls

Maintain claim libraries, category briefs, market matrices, destination acceptance criteria, creator instructions, catalog checks, identity records, and preflight evidence. Connect website and feed releases to live campaigns.

Automation, localization, and bulk duplication require sampling of generated combinations—not approval of one source mockup.
...
Escalate when a shared template or destination is involved, the same label recurs, Account Health worsens, one provider or creator generates repeated issues, a sensitive qualification fails, or any security/payment anomaly appears.
...
## Put a gate before client activation
...
Compare repeat findings, unauthorized changes, review turnaround, incident severity, and corrective-action age across clients without exposing one client’s confidential material to another. Normalize for campaign volume and risk class. Raw rejection counts can punish large portfolios while overlooking a small client with a high repeat rate.
