...
export const guideSections: TopicSection[] = [
  ...
  },
  {
    ...
    title: 'Build accountable agency ad account operations',
    description: 'Evaluate ownership, providers, permissions, billing, verification, security, compliance, incident response, and account portability.',
    intro: 'Agency account arrangements concentrate operational dependencies as well as expertise. Design the ownership, access, money, identity, data, support, and exit controls before committing client spend.',
    accent: 'agency',
    topics: [
